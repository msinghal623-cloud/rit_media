...
function buildSummary(articles) {
  ...
  const base = lead.summary || lead.title;
  return `${sources.length} sources are covering ${base.replace(/\.$/, "")}. This cluster compares reporting from ${sources.slice(0, 3).join(", ")}${sources.length > 3 ? ", and others" : ""}.`;
}
